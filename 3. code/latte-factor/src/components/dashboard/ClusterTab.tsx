    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      <div>
        <h2 style={{ fontSize: 20, fontWeight: 700, marginBottom: 4 }}>
          <span className="gradient-text">Phân cụm K-Means</span>
        </h2>
        ...
        <ResponsiveContainer width="100%" height={320}>
          <ScatterChart margin={{ top: 10, right: 20, bottom: 10, left: 0 }}>
            ...
            <XAxis
              ...
              label={{ value: 'Số tiền (nghìn đ)', position: 'insideBottom', offset: -5, fill: '#64748b', fontSize: 11 }}
            />
            <YAxis
              type="number"
              dataKey="frequency"
              ...
              stroke="#475569"
              tick={{ fill: '#94a3b8', fontSize: 11 }}
              label={{ value: 'Tần suất/tháng', angle: -90, position: 'insideLeft', fill: '#64748b', fontSize: 11 }}
            />
            <Tooltip
          ...
          return (
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
                ...
                <span style={{ fontWeight: 700, fontSize: 15, color: c.isLatteFactor ? '#f59e0b' : '#e2e8f0' }}>
                  {c.isLatteFactor && '⚠️ '}{c.name}
                </span>
